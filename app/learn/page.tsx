    ...
    <div className="bg-background">
      <section className="pt-32 pb-20 bg-gradient-to-br from-primary to-primary-dark">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold text-white sm:text-6xl">Estate Planning Knowledge Center</h1>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            {categories.map((category) => (
              <div key={category.name} className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <ul className="space-y-3">
                  {category.articles.map((article) => (
                    <li key={article} className="flex items-start gap-3">
                      ...
                      <Link href="/learn/blog" className="text-foreground/80 hover:text-primary transition-colors">
                        {article}
                      </Link>
                    </li>
                  ))}
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/learn/blog" className="group bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 text-white hover:shadow-2xl transition-all">
            ...
            <Link href="/learn/faq" className="group bg-gradient-to-br from-secondary to-accent rounded-2xl p-8 text-white hover:shadow-2xl transition-all">
              <svg className="h-12 w-12 mb-4 opacity-80" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <Link href="/learn/guides" className="group bg-gradient-to-br from-primary-dark to-primary rounded-2xl p-8 text-white hover:shadow-2xl transition-all">
              <svg className="h-12 w-12 mb-4 opacity-80" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
